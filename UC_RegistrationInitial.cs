...
{
    public partial class UC_RegistrationInitial : UserControl
    {
        public decimal initialValue = 0;
        private string selectedImagePath = "";

        public UC_RegistrationInitial()
        {
            InitializeComponent();
        ...
        private void btn_InitialDeposit_Click(object sender, EventArgs e)
        {
        ...
        private void btn_deposit_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    MessageBox.Show("Please enter the customer's full name (first and last name).",
                ...
                {
                    MessageBox.Show("Birthdate cannot be 0 years old or in the future.", "Invalid Birthdate", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                    return;
                }
                ...
                if (string.IsNullOrWhiteSpace(contact) || !Regex.IsMatch(contact, @"^09\d{9}$"))
                {
                    MessageBox.Show("Contact number must start with '09' and have 11 digits.",
                ...
                if (!decimal.TryParse(btn_InitialDeposit.Text, out initialDeposit) || initialDeposit < 500)
                {
        ...
        private void cbx_civilstatus_SelectedIndexChanged(object sender, EventArgs e) { }
        private void txtbx_eaddress_TextChanged(object sender, EventArgs e) { }
        ...
        private void btn_InitialDeposit_MouseClick(object sender, MouseEventArgs e) { }
